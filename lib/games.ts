...
export const GAMES: Game[] = [
  {
    ...
    long: "Pilota una nave-paleta y rebota un núcleo de plasma para pulverizar muros de bloques cromáticos a lo largo de 5 niveles fijos. Usa teclado o mouse y salta de nivel desde el menú de pausa. ¿Hasta dónde llegará tu racha?",
    cat: "ARCADE",
  ...
  },
  {
    ...
    long: "Una serpiente de neón recorre la grilla buscando fruta real. Cada bocado la alarga y la hace más veloz. Un movimiento en falso contra el borde o tu propia cola y todo termina.",
    cat: "ARCADE",
    cover: "cover-snake",
    color: "green",
    best: 7820,
